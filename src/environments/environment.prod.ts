export const environment = {
  ...
  apiURL: '/api',
  /**
   * Solo Vercel + Heroku: el rewrite de `vercel.json` sirve el REST a Heroku, pero el edge
   * no proxifica WebSocket. Los WS van directos al mismo backend (debe coincidir con vercel.json).
   */
