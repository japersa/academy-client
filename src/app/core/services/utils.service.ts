...
export class UtilsService {
  ...
  public validationMessages = {
    ...
    email: [
      ...
      { type: 'email', message: 'El formato del email es inválido' }
    ],
    ...
    confirm_password: [
      ...
      { type: 'match_password', message: 'La contraseña no coincide' }
    ],
    ...
    terms_conditions: [
      { type: 'required', message: 'Es obligatorio aceptar los términos y condiciones' },
    ],
    data_politics: [
